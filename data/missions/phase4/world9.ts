...
export const world9Missions: MissionData[] = [
  {
    ...
    slides: [
      ...
      },
      {
        ...
        body: "Stripe and LemonSqueezy solve the same job: accept payments, handle subscriptions, manage billing. The main deciding factor is country availability and business access. If Stripe is available in your country, use Stripe. If Stripe is not available, LemonSqueezy is a great alternative. This is not a deep technical decision. This should not block your launch.",
      },
      {
        type: "quiz",
        question: "Stripe is not available in my country. What should I do?",
        options: [
          { id: "a", text: "Give up on payments", correct: false },
          { id: "b", text: "Use LemonSqueezy instead", correct: true },
          { id: "c", text: "Wait for Stripe to expand", correct: false },
        ],
      },
      {
        type: "buildTask",
        title: "Set Up Payment Provider",
        description: "Pick what works where you live and move on",
        task: "Tell Cursor: 'I want to charge users for this app. Help me set up Stripe (or LemonSqueezy if Stripe isn't available). I need to install the library and know where to put my keys.'",
        expectedOutcome: "Payment provider set up and ready for checkout",
        verificationSteps: [
          "Payment library installed",
        ...
        tips: [
          ...
          "Do not overthink this choice",
        ],
      },
      {
        type: "speedQuiz",
        title: "Payment Decision",
        description: "Make the right choice and move forward",
        questions: [
          {
            id: "q1",
            question: "I just want to launch and take payments. What matters most here?",
            options: [
              { id: "a", text: "Feature comparison charts" },
              { id: "b", text: "What's available in my country" },
              { id: "c", text: "Which one has more integrations" },
            ],
            correct: "b",
            timeLimit: 12,
          },
          {
            id: "q2",
            question: "Stripe is available where I live. Should I use it?",
            options: [
              { id: "a", text: "Yes, use Stripe and move on" },
              { id: "b", text: "No, research more options first" },
              { id: "c", text: "Maybe, compare features first" },
            ],
            correct: "a",
            timeLimit: 12,
          },
      ...
      {
        type: "identify",
        prompt: "What should you do if Stripe is not available in your country?",
        correctOptionId: "lemonsqueezy",
        correctExplanation: "Yes. Use LemonSqueezy. Both solve the same problem. Pick what works where you live.",
        wrongExplanation: "Do not overthink this. Both tools accept payments. Choose what's available.",
        options: [
          { id: "wait", text: "Wait for Stripe", icon: "⏳" },
          { id: "lemonsqueezy", text: "Use LemonSqueezy", icon: "🍋" },
          { id: "research", text: "Research 10 more options", icon: "🔍" },
        ],
      },
      {
        type: "text",
        title: "The Real Takeaway",
        body: "You are not choosing a payment philosophy. You are choosing what is available to you so you can launch. Both Stripe and LemonSqueezy accept payments. Both handle subscriptions. Both manage billing. Pick what works where you live. Move on. Ship.",
      },
    ],
  },
  {
