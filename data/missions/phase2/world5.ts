...
export const world5Missions: MissionData[] = [
  {
    ...
    slides: [
      ...
      },
      {
        ...
        description: "Direct AI to add authentication",
        task: "Tell Cursor: 'Add a login page to my app using Supabase Auth. It should support Email/Password and Google Login.'",
        ...
        tips: [
          "AI might install a helper library, that's fine",
          "Ask AI how to enable Google Login in Supabase dashboard if you get stuck",
        ],
      },
      {
        type: "text",
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        description: "Ask AI to create the profiles table",
        task: "Tell Cursor: 'I need a profiles table to track user data like subscription plan and message count. Please write the SQL to create it, linked to the auth.users table.'",
        expectedOutcome: "SQL code to create the profiles table",
        verificationSteps: [
          "SQL generated",
          "Links to auth.users",
          "Includes subscription/usage fields",
        ],
        tips: [
          "Paste the SQL into Supabase",
          "This separates your app data from auth data",
        ],
      },
      {
        type: "text",
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        description: "Direct AI to protect the app",
        task: "Tell Cursor: 'Create Middleware that protects my /chat route. If a user isn't logged in, redirect them to /login.'",
        expectedOutcome: "Middleware that protects /chat route",
        verificationSteps: [
          "AI created the middleware file",
          "It checks for a session",
          "Unauthenticated users get redirected",
        ],
        tips: [
          "Middleware runs before every request",
          "This keeps your app secure",
        ],
      },
      {
        type: "text",
