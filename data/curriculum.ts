    ...
    },
    {
      ...
      worlds: [
        ...
        },
        {
          id: 4,
          phaseId: 2,
          slug: "make-data-exist",
          title: "The Brain (Backend)",
          subtitle: "Apps shouldn't have amnesia",
          missions: [
            { id: "setup-the-vault", title: "Setup The Vault", xpReward: 20 },
            { id: "design-memory", title: "Design The Memory", xpReward: 20 },
            { id: "connect-wires", title: "Connect The Wires", xpReward: 20 },
          ...
          secretDrop: {
            title: "The 'Fix It' Prompt",
            description: "One prompt to fix any database connection error."
          }
        },
        {
          id: 5,
