  ...
  return (
    <div className="max-w-4xl mx-auto py-12 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-purple-500/30 transition-all duration-300 group relative overflow-hidden">
           <div className="absolute top-0 right-0 p-3 bg-purple-500/10 rounded-bl-2xl border-b border-l border-purple-500/20 text-purple-300 text-xs font-medium uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-opacity">
                Vibe Mode
           </div>
           ...
           <p className="text-white/40 mb-8 font-light leading-relaxed h-12 relative z-10">
              Pick up where you left off on the Vibe Coding Course map. Your next breakthrough awaits.
           </p>
           <Link href="/dashboard/course" className="relative z-10">
        ...
        <div className="p-8 rounded-2xl bg-transparent border border-white/5 flex flex-col justify-center items-center text-center opacity-60 hover:opacity-100 transition-opacity">
